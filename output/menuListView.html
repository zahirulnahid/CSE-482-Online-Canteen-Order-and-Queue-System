...
<body class="bg-pink-100 scroll-smooth font-semibold min-h-screen bg-cover bg-no-repeat w-full"
    ...
    <div class="flex m-14">
        ...
        <div class="px-20 my-4 p-4 w-full float-left">
            ...
            <button href="invoice.html" class=" p-5 min-w-fit   float-right bg-pink-700 text-gray-100 hover:text-gray-800 hover:bg-pink-100 rounded-full border-spacing-2
