    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="relative flex items-center">
            <div class="dropdown inline-block relative">
                ...
                <ul class="dropdown-menu absolute hidden text-gray-700 bg-white mt-2 px-5 py-3 rounded-lg divide-y divide-gray-200">
                    <?php
                    ...
                    if (mysqli_num_rows($res) > 0) {
                        while ($rows = mysqli_fetch_assoc($res)) {
                            ...
                            echo '<li><a href="' . $_SERVER['PHP_SELF'] . '?nid=' . $notificationId . '" class="block px-5 py-3 hover:bg-gray-100">' . $rows["title"] . '<br>' . $rows["details"] . '</a></li>';
                            $notificationCount++; }
                    } else {
